    ...
    <div className="min-h-[75vh] flex items-center justify-center py-8">
      <Card className="w-full max-w-md bg-zinc-900 border-zinc-800 text-zinc-100">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Create Rooted Account</CardTitle>
          <CardDescription className="text-zinc-400 text-xs">
            Start load-aware routing for agricultural freight
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div className="space-y-1">
              <Label className="text-xs text-zinc-300">Organization Role</Label>
              <Select value={role} onValueChange={setRole}>
                <SelectTrigger className="bg-zinc-950 border-zinc-800 text-zinc-100">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-zinc-900 border-zinc-800 text-zinc-100">
                  <SelectItem value="producer">Producer / Farm Owner</SelectItem>
                  <SelectItem value="carrier">Agricultural Carrier</SelectItem>
                  <SelectItem value="cooperative">Grain Cooperative</SelectItem>
                  <SelectItem value="logistics_manager">Logistics Manager</SelectItem>
                  <SelectItem value="storage_operator">Elevator Operator</SelectItem>
                </SelectContent>
              </Select>
            </div>
