  ...
  return (
    <div className="space-y-6 py-2">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold">Route Infrastructure Details</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <h2 className="text-base font-semibold">Infrastructure Restrictions En Route</h2>
          <RestrictionCard
        ...
        <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-subtle">
          <h2 className="text-base font-semibold">Estimated Cost Breakdown</h2>
          <div className="space-y-2 text-xs">
            {[
              ['Fuel Expense (48.7 mi @ 5.8 mpg)', '$142.00'],
              ['Driver Time & Wage', '$185.00'],
              ['Equipment Depreciation', '$124.00'],
              ['Risk & Toll Contingency', '$50.00'],
            ].map(([label, val]) => (
              <div
                key={label}
                className="flex justify-between py-1 border-b border-border text-muted-foreground"
              >
                <span>{label}</span>
                <span className="font-semibold text-foreground">{val}</span>
              </div>
            ))}
            <div className="flex justify-between py-2 font-bold text-sm text-primary">
